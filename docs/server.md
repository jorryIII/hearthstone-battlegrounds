...
بخش خوشگل‌سازی و **UI** تموم شد. اونجا هر گندی می‌زدید نهایتاً یه دکمه کج می‌شد یا یه پیکسل می‌سوخت. ولی اینجا **Backend** هست. اینجا **"منطق"** حرف اول رو می‌زنه. اینجا اگه اشتباه کنید، دیتابیس به فنا میره، **گیم‌لوپ (Game Loop)** کرش می‌کنه و …
